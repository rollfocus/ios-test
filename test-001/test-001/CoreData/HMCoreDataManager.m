...
-(NSPersistentStoreCoordinator*)persistentStoreCoordinator
{
    ...
    NSURL *url = [[self getDocumentsUrl] URLByAppendingPathComponent:dbName isDirectory:YES];
...
- (NSPersistentContainer *)persistentContainer
{
     ...
     * name:数据库文件名称
     */
    _persistentContainer = [[NSPersistentContainer alloc] initWithName:dbName managedObjectModel:model];
